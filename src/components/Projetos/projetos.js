...
export default function Projetos(){
    return(
        ...
        <h3 id="titulo">Projetos</h3>
            <div className="card">
                <h2>Creatina Page</h2>
                <img src="./images/paginaCreatina.PNG" alt="print do site"></img>
            ...
            <div className="card">
                ...
                <img src="./images/listaDeTarefas.png" alt="print do site"></img>
            ...
            <div className="card">
                ...
                <img src="./images/correnteXtensao.png" alt="print do site"></img>
            ...
            <div className="card">
                ...
                <img src="./images/diadosnamorados.png"  alt="print so site"></img>
